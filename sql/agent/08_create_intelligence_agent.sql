...
GRANT USAGE ON PROCEDURE ADF_INTELLIGENCE.ANALYTICS.PREDICT_PAYMENT_VOLUME(INT) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE ADF_INTELLIGENCE.ANALYTICS.PREDICT_BORROWER_RISK(VARCHAR) TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE ADF_INTELLIGENCE.ANALYTICS.PREDICT_COLLECTION_SUCCESS(VARCHAR) TO ROLE SYSADMIN;
